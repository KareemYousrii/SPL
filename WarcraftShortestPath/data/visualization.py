...
@input_to_numpy
def draw_paths_on_image(image, true_path, suggested_path, scaling_factor, color):
    #transpose = True
    ...
    visualized = draw_paths_on_image_as_line(image=image,
                                             ...
                                             color="#FFFF00")
    #visualized = draw_paths_on_image_as_dots(image=image,
    #                                         path=suggested_path,
    #                                         sf=scaling_factor, color=color)
    if transpose:
